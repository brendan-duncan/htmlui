...
{
    /// <summary>
    /// The script injected into each preview page. It builds the same DOM shape as <c>HtmlUI.jslib</c>
...
(function () {
  ...
  var HUI = {
    ...
    // Mirrors HUI.onDomEvent in HtmlUI.jslib: the payload must deserialize into WebUI.Html.HtmlEvent.
