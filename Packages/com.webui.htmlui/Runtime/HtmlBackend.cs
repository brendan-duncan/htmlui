...
{
    /// <summary>
    /// An alternative implementation of the browser bridge, used where <c>HtmlUI.jslib</c> cannot run.
    /// The Editor registers one that drives a real Chrome over the DevTools Protocol
    /// (see <c>WebUI.Html.Editor.CdpHtmlBackend</c>), so documents render and respond in the Game view.
    /// </summary>
    /// <remarks>
    ...
    public interface IHtmlBackend
    {
        ...
        /// <summary>Comma-separated element handles, matching the jslib's HtmlUI_QueryAll encoding.</summary>
    ...
    /// <see cref="HtmlNative"/> talks to <c>HtmlUI.jslib</c> directly.
    /// </summary>
